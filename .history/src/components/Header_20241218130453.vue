<template>
  <header class="flex flex-col items-center justify-between p-4 bg-gray-800 dark:bg-gray-900 text-white dark:text-gray-200 shadow-lg">
    <div class="flex items-center justify-between w-full mb-4">
      ...
      <button @click="toggleTheme" class="rounded-full bg-gradient-to-r from-green-400 to-green-600 text-white shadow-md hover:from-green-500 hover:to-green-700 transition-all" aria-label="Toggle Dark/Light Mode">
